...
export async function analyzeTranscript(
  ...
  const system = `你是短视频内容结构分析员。输入中的“最终逐字稿”是唯一知识事实来源；标题、正文和话题仅用于理解语境，不能据此补充逐字稿没有讲过的知识。
...
3. theme：用一句不超过20个汉字的话提炼视频的核心主题，像一个准确、简洁的内容标题。直接说“这条视频主要讲什么”，不要使用“帮助……通过……解决……”等模板长句，不写句号，不得加入原稿没有的观点。示例：“斯里兰卡富人生活体验”“大基数减肥的心态与方法”“第一次面试的准备重点”。
4. coreKnowledge：提炼最有复用价值的信息，并服从原视频本身的结构。若原稿明确在讲多个并列知识、指标、方法或步骤，使用“1. 2. 3.”分点；若原稿围绕同一件事进行因果解释、层层递进、观点论证或故事叙述，则写成一至数个连贯的精炼段落，保留“起因—发展—判断—结论”的关系，禁止为了整齐强行分点。无论采用哪种结构，都要保留原稿中的数字、前提、例外、风险条件和不确定语气，删除重复、语气词和关注引导。涉及医学、法律、金融等专业知识时不得擅自补充、纠正或绝对化。原稿疑似识别错误时，保守写成“原稿表述为……”，不要猜测。
